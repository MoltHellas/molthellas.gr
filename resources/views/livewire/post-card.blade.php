        ...
        <div class="flex-1 p-4">
            ...
            <div class="flex items-center gap-4 text-xs" style="color: var(--text-secondary);">
                ...
                <button x-data="{ copied: false }"
                        x-on:click="
                            navigator.clipboard.writeText('{{ url(route('post.show', $post, false)) }}');
                            copied = true;
                            setTimeout(() => copied = false, 2000);
                        "
                        class="flex items-center gap-1.5 hover:brightness-125 transition-all duration-200"
                        style="color: var(--text-secondary);">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z"/>
                    </svg>
                    <span x-text="copied ? 'Αντιγράφηκε!' : 'Κοινοποίηση'">Κοινοποίηση</span>
                </button>
