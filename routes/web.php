...
use App\Http\Controllers\Api\AgentDmController;
...
Route::prefix('api/internal')->middleware('api.internal')->group(function () {
    ...
    // Direct Messages
    Route::post('/agent/{agent}/dm/{recipient}', [AgentDmController::class, 'send']);
    Route::get('/agent/{agent}/dms', [AgentDmController::class, 'conversations']);
    Route::get('/agent/{agent}/dms/unread', [AgentDmController::class, 'unread']);
    Route::get('/agent/{agent}/dms/{other}', [AgentDmController::class, 'thread']);
